...
public class StatisticsActivity_graph extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(StatisticsActivity_graph.this, StatisticsActivity_home.class);
        ...
        vote.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(StatisticsActivity_graph.this, StatisticsActivity_vote.class);
                startActivity(intent);
            }
        });
        ...
        create.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(StatisticsActivity_graph.this, StatisticsActivity_create.class);
                startActivity(intent);
            }
        });
        ...
        graph.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(StatisticsActivity_graph.this, StatisticsActivity_graph.class);
                startActivity(intent);
            }
        });
